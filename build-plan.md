...
Status: refactor done 2026-08-18. Wiring + new modules completed 2026-08-20. All py_compile clean. Runtime VM verification pending — see checklist below. **2026-08-20 code review found and fixed 2 real bugs** (see items below) — `_snapshot()` itself checked out correctly, called at the top of every mutating action as claimed.
