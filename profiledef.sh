...
iso_version="${DARKOS_ISO_VERSION:-$(date -u +%Y.%m.%d)}"
install_dir="arch"
buildmodes=('iso')
...
file_permissions=(
  ...
  ["/usr/share/icons/darkos/darkos.png"]="0:0:644"
  ["/var/lib/AccountsService/users/greeter"]="0:0:644"
  ...
  ["/usr/local/bin/darkos-ai-snapshot"]="0:0:755"
